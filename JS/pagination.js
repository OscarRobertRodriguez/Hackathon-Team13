       /* var moveit=document.getElementById('img');


          function ani(){
            moveit.className ='classname';
          };


          moveit.addEventListener('click',function(event){

          	var startMouseXPos=event.clientX;
        	var startMouseYPos=event.clientY;
        	var endX=startMouseXPos-100;
        	var endY=startMouseYPos-100;
        	//alert("startX "+startMouseXPos+" startY "+startMouseYPos);
            //moveit.style.transform="translate("+endX+"px,"+endY+"px)";
            //moveit.style.backgroundImage="radial-gradient(circle ,#000,#fff)";
		   /* moveit.style.content= "";
		    moveit.style.background= "#90EE90";
		    moveit.style.display= "block";
		    moveit.style.position= "absolute";
		    moveit.style.paddingTop= "300%";
		    moveit.style.paddingLeft= "350%";
		    moveit.style.marginLeft= "-20px!important";
		    moveit.style.marginTop= "-120%";
		    moveit.style.opacity= 0;
		    moveit.style.transition= "background-image 1.8s";
            ...
            /*******************************************
var moveit=document.getElementById("img");
moveit.addEventListener("mousedown", mouseDown);
moveit.addEventListener("mouseup", mouseUp);

function mouseDown() {

     moveit.style.border="5px solid black";
     moveit.style.backgroundImage="radial-gradient(circle ,#000, #fff)";
}

function mouseUp() {

    moveit.style.backgroundImage="";
}   	
